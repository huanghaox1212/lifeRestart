...
class App{
    ...
    initPages() {
        ...
        propertyPage
            ...
            .click(()=>{
                let t = this.#totalMax;
                const arr = [200, 200, 200, 200];
                while(t>0) {
                    const sub = Math.round(Math.random() * (Math.min(t, 200) - 1)) + 1;
                    while(true) {
                ...
                groups.CHR.set(200 - arr[0]);
                groups.INT.set(200 - arr[1]);
                groups.STR.set(200 - arr[2]);
                groups.MNY.set(200 - arr[3]);
            });
